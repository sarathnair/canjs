...
/*can-simple-dom@0.4.5#simple-dom/document/node*/
...
/*can-simple-dom@0.4.5#simple-dom/document/element*/
...
/*can-simple-dom@0.4.5#simple-dom/document/text*/
...
/*can-simple-dom@0.4.5#simple-dom/document/comment*/
...
/*can-simple-dom@0.4.5#simple-dom/document/document-fragment*/
...
/*can-simple-dom@0.4.5#simple-dom/extend*/
...
/*can-simple-dom@0.4.5#simple-dom/document/anchor-element*/
...
/*can-simple-dom@0.4.5#simple-dom/document/utils.js*/
define('can-simple-dom/simple-dom/document/utils.js', ['exports'], function (exports) {
    'use strict';
...
/*can-simple-dom@0.4.5#simple-dom/document/input-element*/
define('can-simple-dom/simple-dom/document/input-element', [
    'exports',
    'module',
    'can-simple-dom/simple-dom/document/element',
    'can-simple-dom/simple-dom/document/utils.js'
], function (exports, module, _element, _utilsJs) {
    'use strict';
    function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : { 'default': obj };
    }
    ...
    InputElement.prototype = Object.create(_Element['default'].prototype);
    InputElement.prototype.constructor = InputElement;
    InputElement.prototype.elementConstructor = _Element['default'];
    (0, _utilsJs.propToAttr)(InputElement, 'type');
    (0, _utilsJs.propToAttr)(InputElement, 'value');
...
/*can-simple-dom@0.4.5#simple-dom/document/utils*/
...
define('can-simple-dom/simple-dom/document/option-element', [
    ...
    OptionElement.prototype = Object.create(_Element['default'].prototype);
    OptionElement.prototype.constructor = OptionElement;
    OptionElement.prototype.elementConstructor = _Element['default'];
...
/*can-simple-dom@0.4.5#simple-dom/document/select-element*/
define('can-simple-dom/simple-dom/document/select-element', [
    ...
    SelectElement.prototype = Object.create(_Element['default'].prototype);
    SelectElement.prototype.constructor = SelectElement;
    SelectElement.prototype.elementConstructor = _Element['default'];
    (0, _utils.propToAttr)(SelectElement, 'value');
    module.exports = SelectElement;
});
/*can-simple-dom@0.4.5#simple-dom/document*/
define('can-simple-dom/simple-dom/document', [
...
], function (exports, module, _documentNode, _documentElement, _documentText, _documentComment, _documentDocumentFragment, _documentAnchorElement, _documentInputElement, _documentOptionElement, _documentSelectElement) {
    'use strict';
    function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : { 'default': obj };
    }
    ...
    var _InputElement = _interopRequireDefault(_documentInputElement);
    var _OptionElement = _interopRequireDefault(_documentOptionElement);
    var _SelectElement = _interopRequireDefault(_documentSelectElement);
    function Document() {
    ...
    var specialElements = {
            'a': _AnchorElement['default'],
            'input': _InputElement['default'],
            'option': _OptionElement['default'],
            'select': _SelectElement['default']
        };
...
/*can-simple-dom@0.4.5#simple-dom/event*/
define('can-simple-dom/simple-dom/event', [
    'exports',
    'module',
    'can-simple-dom/simple-dom/document/node',
    'can-simple-dom/simple-dom/document'
], function (exports, module, _documentNode, _document) {
    'use strict';
    function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : { 'default': obj };
    }
    ...
    _Document['default'].prototype.createEvent = function (type) {
        return new Event();
    };
    _Node['default'].prototype.addEventListener = function (event, handler, capture) {
        if (!this.__handlers) {
    ...
    _Node['default'].prototype.removeEventListener = function (event, handler, capture) {
        if (this.__handlers) {
            var phase = capture ? 'capture' : 'bubble';
            var handlersByType = this.__handlers[event + ' ' + phase];
            if (handlersByType) {
    ...
    _Node['default'].prototype.dispatchEvent = function (event) {
        event.target = this;
        var cur = this;
...
/*can-simple-dom@0.4.5#simple-dom/html-parser*/
...
/*can-simple-dom@0.4.5#simple-dom/html-serializer*/
...
/*can-simple-dom@0.4.5#simple-dom/void-map*/
...
/*can-simple-dom@0.4.5#simple-dom/dom*/
...
], function (exports, _documentNode, _documentElement, _document, _event, _htmlParser, _htmlSerializer, _voidMap) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
    function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : { 'default': obj };
...
/*can-simple-dom@0.4.5#simple-dom*/
