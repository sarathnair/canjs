...
var _documentInputElement = require('./document/input-element.js');
var _documentInputElement2 = _interopRequireDefault(_documentInputElement);
var _documentOptionElement = require('./document/option-element.js');
var _documentOptionElement2 = _interopRequireDefault(_documentOptionElement);
var _documentSelectElement = require('./document/select-element.js');
var _documentSelectElement2 = _interopRequireDefault(_documentSelectElement);
function Document() {
...
var specialElements = {
        'a': _documentAnchorElement2['default'],
        'input': _documentInputElement2['default'],
        'option': _documentOptionElement2['default'],
        'select': _documentSelectElement2['default']
    };
