...
_documentNode2['default'].prototype.addEventListener = function (event, handler, capture) {
    if (!this.__handlers) {
...
_documentNode2['default'].prototype.removeEventListener = function (event, handler, capture) {
    if (this.__handlers) {
        var phase = capture ? 'capture' : 'bubble';
        var handlersByType = this.__handlers[event + ' ' + phase];
        if (handlersByType) {
...
_documentNode2['default'].prototype.dispatchEvent = function (event) {
    event.target = this;
    var cur = this;
